...
// Values are added to this buffer by the code in isr.c. Values are removed from this queue
// by code in detector.c
...
// This adds data to the ADC queue. Data are removed from this queue and used by the detector.
